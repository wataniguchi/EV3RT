    ...
    loop_01.add_children(
        [
            TraceLineCam(name="straight 01", power=TraceNum.POWER_SLOW1,                    
                         ...
                         scene=Scene.DEBRI,
                         gs_min=TraceNum.GS_MIN1, gs_max=TraceNum.GS_MAX1, trace_side=TraceSide.NORMAL),
    ...
    loop_031.add_children(
        [
            TraceLineCam(name="curve 010", power=TraceNum.POWER_SLOW1,                    
                         pid_p=TraceNum.PID_P_SLOW1, pid_i=TraceNum.PID_I_SLOW1, pid_d=TraceNum.PID_D_SLOW1,
                         scene=Scene.DEBRI,
                         gs_min=TraceNum.GS_MIN1, gs_max=TraceNum.GS_MAX1, trace_side=TraceSide.OPPOSITE),
...
#    )
    ...
    debri_01.add_children(
        [
            TraceLineCam(name="run vertical", power=DebriNum.POWER_NORMAL, 
                         ...
                         gs_min=TraceNum.GS_MIN1, gs_max=TraceNum.GS_MAX1, scene=Scene.DEBRI, trace_side=TraceSide.CENTER),
    ...
    debri_07.add_children(
        [
            TraceLineCam(name="run side", power=DebriNum.POWER_SLOW, 
                         pid_p=DebriNum.PID_P, pid_i=DebriNum.PID_I, pid_d=DebriNum.PID_D,
                         gs_min=TraceNum.GS_MIN1, gs_max=TraceNum.GS_MAX1, scene=Scene.DEBRI, trace_side=TraceSide.NORMAL),
    ...
    carry_02.add_children(
        [
            TraceLineCam(name="trace normal edge", power=34, pid_p=1.9, pid_i=0.001, pid_d=0.1,scene=Scene.DEBRI, gs_min=TraceNum.GS_MIN1, gs_max=TraceNum.GS_MAX1, trace_side=TraceSide.CENTER),
    ...
    carry_10.add_children(
        [
            TraceLineCam(name="trace normal edge", power=36, pid_p=1.7, pid_i=0.0015, pid_d=0.1,scene=Scene.DEBRI, gs_min=TraceNum.GS_MIN1, gs_max=TraceNum.GS_MAX1, trace_side=TraceSide.NORMAL),
        ]
    )
