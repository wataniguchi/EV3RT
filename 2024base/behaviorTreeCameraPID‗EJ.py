...
def build_behaviour_tree() -> BehaviourTree:
    ...
    loop_01A = Parallel(name="loop 01A", policy=ParallelPolicy.SuccessOnOne())
    loop_01B = Parallel(name="loop 01B", policy=ParallelPolicy.SuccessOnOne())
    loop_01C = Parallel(name="loop 01C", policy=ParallelPolicy.SuccessOnOne())
    loop_01D = Parallel(name="loop 01D", policy=ParallelPolicy.SuccessOnOne())
    loop_01E = Parallel(name="loop 01E", policy=ParallelPolicy.SuccessOnOne())
    loop_01F = Parallel(name="loop 01F", policy=ParallelPolicy.SuccessOnOne())
