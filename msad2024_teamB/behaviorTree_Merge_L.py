...
# 1列目
    ...
    dbr_loop_12.add_children(
        [
            MoveStraightLR(name="move straight 4", right_power=0, left_power=60, target_distance=112),
        ]
    )
# 2列目
    # 指定距離走行_before、赤青判定
    ...
    dbr_loop_14.add_children(
        [
            MoveStraight_dbr(name="move straight", power=40, target_distance=180),
        ]
    )
    ...
    dbr_loop_18.add_children(
        [
            MoveStraight_dbr(name="back", power=-50, target_distance=105)
        ]
    )
    # 指定距離走行_after
    ...
    dbr_loop_24.add_children(
        [
            MoveStraight(name="move straight", power=40, target_distance=280),
        ]
    )
    # バック
    ...
    dbr_loop_26.add_children(
        [
            MoveStraightLR(name="move straight 4", right_power=60, left_power=0, target_distance=190),
        ]
    )
# 3列目
    # 指定距離走行_before、赤青判定
    ...
    dbr_loop_28.add_children(
        [
            MoveStraight_dbr(name="move straight", power=40, target_distance=142),
        ]
    )
    dbr_loop_29.add_children(
        [
            MoveStraightLR_dbr(name="move straight 4", right_power=60, left_power=10, target_distance=215),
        ]
    )
    ...
    dbr_loop_31.add_children(
        [
            MoveStraightLR_dbr(name="move straight 4", right_power=-60, left_power=-10, target_distance=195),
        ]
    )
...
#     )
    ...
    step_03B_3.add_children(
        [
            MoveStraightLR(name="Turn 3", right_power=50, left_power=0, target_distance=210),
