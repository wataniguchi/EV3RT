...
# 1列目
    ...
    loop_01.add_children(
        [
        TraceLineCam(name="trace normal edge", power=38, pid_p=1.1, pid_i=0.0015, pid_d=0.1,
    ...
    loop_11.add_children(
        ...
        IsDistanceEarned(name="check distance", delta_dist=275),
        ]
    )
    # 右に90度回転
...
# 2列目
    ...
    loop_13.add_children(
        [
        TraceLineCam(name="trace normal edge", power=32, pid_p=1.1, pid_i=0.0015, pid_d=0.1,
