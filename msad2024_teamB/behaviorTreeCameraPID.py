...
def build_behaviour_tree() -> BehaviourTree:
    ...
    loop_22 = Parallel(name="loop 20", policy=ParallelPolicy.SuccessOnOne())
    loop_23 = Parallel(name="loop 20", policy=ParallelPolicy.SuccessOnOne())
    ...
    loop_01.add_children(
        [
        TraceLineCam(name="trace normal edge", power=45, pid_p=0.5, pid_i=0.0015, pid_d=0.1,
    ...
    loop_02.add_children(
        [
            MoveStraight_dbr(name="move straight", power=40, target_distance=100),
        ]
    )
    ...
    loop_11.add_children(
        [
        TraceLineCam(name="trace normal edge", power=30, pid_p=0.5, pid_i=0.0015, pid_d=0.1,gs_min=0, gs_max=80, trace_side=TraceSide.NORMAL),
        IsDistanceEarned(name="check distance", delta_dist=290),
    ...
    loop_14.add_children(
        [
        TraceLineCam(name="trace normal edge", power=35, pid_p=0.5, pid_i=0.0015, pid_d=0.1,
    ...
    loop_21.add_children(
        [
            MoveStraight(name="move straight", power=40, target_distance=230),
        ]
    )
    loop_22.add_children(
        [
            MoveStraight(name="back", power=-50, target_distance=220)
        ]
    )
    loop_23.add_children(
        [
            MoveStraightLR(name="move straight 4", right_power=60, left_power=0, target_distance=280),
        ]
    )
    root.add_children(
        [
