...
def build_behaviour_tree() -> BehaviourTree:
    ...
    loop_01.add_children(
        [
        TraceLineCam(name="trace normal edge", power=43, pid_p=1.0, pid_i=0.0015, pid_d=0.1,
    ...
    loop_07.add_children(
        [
        TraceLineCam(name="trace normal edge", power=40, pid_p=0.8, pid_i=0.0015, pid_d=0.1,gs_min=0, gs_max=80, trace_side=TraceSide.NORMAL),
