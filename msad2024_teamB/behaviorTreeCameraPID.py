...
def build_behaviour_tree() -> BehaviourTree:
    ...
    loop_14.add_children(
        [
        TraceLineCam(name="trace normal edge", power=33, pid_p=1.0, pid_i=0.0015, pid_d=0.1,
    ...
    loop_22.add_children(
        [
            MoveStraight(name="back", power=-50, target_distance=130)
        ]
    )
    ...
    loop_24.add_children(
        [
        TraceLineCam(name="trace normal edge", power=29, pid_p=0.8, pid_i=0.0015, pid_d=0.1,gs_min=0, gs_max=80, trace_side=TraceSide.NORMALSITE),
    ...
    loop_35.add_children(
        [
            MoveStraight(name="move straight", power=45, target_distance=350),
        ]
    )
