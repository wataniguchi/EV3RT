...
# 1列目
    ...
    step_02B.add_children(
        [
            MoveStraightLR(name="Turn 1", right_power=15, left_power=70, target_distance=255), #LEFT
    ...
    step_03B_3.add_children(
        [
            MoveStraightLR(name="Turn 3", right_power=50, left_power=0, target_distance=220),
