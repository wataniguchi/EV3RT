...
def build_behaviour_tree() -> BehaviourTree:
    ...
    wloop_03.add_children(
        [
            TraceLineCam(name="trace normal edge", power=40, pid_p=1.0, pid_i=0.0010, pid_d=0.3,
                         gs_min=0, gs_max=80, trace_side=TraceSide.NORMAL),
    ...
    wloop_08.add_children(
        [
            TraceLineCam(name="trace normal edge", power=44, pid_p=2.0, pid_i=0.0015, pid_d=0.35,
                         gs_min=0, gs_max=80, trace_side=TraceSide.NORMAL),
...
# 1列目
    ...
    dbr_loop_08.add_children(
        [
            MoveStraight(name="move straight", power=40, target_distance=345),
        ]
    )
    # バック
    dbr_loop_09.add_children(
        [
            MoveStraight(name="back", power=-32, target_distance=180)
        ]
    )
    # 右に90度回転
    dbr_loop_10.add_children(
        [
            MoveStraightLR(name="move straight 4", right_power=0, left_power=60, target_distance=118),
        ]
    )
    ...
    dbr_loop_13.add_children(
        [
            MoveStraightLR_dbr(name="move straight 4", right_power=70, left_power=15, target_distance=180),
        ]
    )
    ...
    step_02B.add_children(
        [
            MoveStraightLR(name="Turn 1", right_power=15, left_power=70, target_distance=260), #LEFT
            MoveStraight(name="free run 2", power=70, target_distance=1020),
    ...
    step_03B_3.add_children(
        [
            MoveStraightLR(name="Turn 3", right_power=50, left_power=0, target_distance=205),
