...
def build_behaviour_tree() -> BehaviourTree:
    ...
    step_01B = Parallel(name="step 03B_2", policy=ParallelPolicy.SuccessOnOne())
    ...
    step_02B.add_children(
        [
            ...
            MoveStraightLR(name="Turn 1", right_power=83, left_power=10, target_distance=200), #RIGHT
    ...
    step_03B_1.add_children(
        [
            ...
            MoveStraightLR(name="Turn 2", right_power=0, left_power=40, target_distance=300), #RIGHT
