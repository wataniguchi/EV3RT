...
# 1列目
    ...
    loop_05.add_children(
        [
            MoveStraightLR_dbr(name="move straight 4", right_power=-10, left_power=-60, target_distance=110),
        ]
    )
    ...
    loop_07.add_children(
        [
        TraceLineCam(name="trace normal edge", power=40, pid_p=1.0, pid_i=0.0015, pid_d=0.1,gs_min=0, gs_max=80, trace_side=TraceSide.CENTER),
    ...
    loop_11.add_children(
        ...
        TraceLineCam(name="trace normal edge", power=35, pid_p=0.8, pid_i=0.0015, pid_d=0.1,
                         gs_min=0, gs_max=80, trace_side=TraceSide.OPPOSITE),
        IsDistanceEarned_before(name="check distance", delta_dist = 1270),
        IsRedColorDetected(name="check red color", threshold=12.0), 
        IsBlueColorDetected(name="check blue color", threshold=12.0), 
        ]
    )
    ...
    loop_15.add_children(
        [
            MoveStraightLR_dbr(name="move straight 4", right_power=-10, left_power=-60, target_distance=135),
        ]
    )
