...
def build_behaviour_tree() -> BehaviourTree:
    ...
    loop_01.add_children(
        [
            TraceLineCam(name="trace normal edge", power=50, pid_p=3, pid_i=0.0015, pid_d=0.3,
    ...
    loop_02.add_children(
        [
            TraceLineCam(name="trace normal edge", power=45, pid_p=3, pid_i=0.001, pid_d=0.35,
                         gs_min=0, gs_max=80, trace_side=TraceSide.NORMAL),
    ...
    loop_03.add_children(
        [
            TraceLineCam(name="trace opposite edge", power=45, pid_p=3, pid_i=0.0011, pid_d=0.35,
    ...
    loop_04.add_children(
        [
            TraceLineCam(name="trace normal edge", power=45, pid_p=3, pid_i=0.0015, pid_d=0.3,
                         gs_min=0, gs_max=80, trace_side=TraceSide.NORMAL),
    ...
    loop_05.add_children(
        [
            TraceLineCam(name="trace normal edge", power=45, pid_p=3, pid_i=0.0011, pid_d=0.35,
                         gs_min=0, gs_max=80, trace_side=TraceSide.NORMAL),
            IsJunction(name="scan joined junction", target_state = JState.JOINED),
        ]
    )
