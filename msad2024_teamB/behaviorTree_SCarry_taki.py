...
def build_behaviour_tree() -> BehaviourTree:
    ...
    step_02B.add_children(
        [
            MoveStraightLR(name="Turn 1", right_power=50, left_power=35, target_distance=200),
    ...
    step_03B.add_children(
        [
            ...
            MoveStraightLR(name="Turn 2", right_power=35, left_power=50, target_distance=200),
    ...
    step_04B.add_children(
        [
            MoveStraightLR(name="Turn 3", right_power=-50, left_power=50, pid_i=0.0015, pid_d=0.1,
                         gs_min=0, gs_max=80, trace_side=TraceSide.CENTER),
