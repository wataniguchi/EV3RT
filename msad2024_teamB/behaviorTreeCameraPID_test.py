...
def build_behaviour_tree() -> BehaviourTree:
    ...
    loop_01.add_children(
        [
            TraceLineCam(name="trace normal edge", power=70, pid_p=1.0 pid_i=0.0015, pid_d=0.5,
    ...
    loop_01_1.add_children(
        [
            TraceLineCam(name="trace normal edge", power=60, pid_p=1.5, pid_i=0.0015, pid_d=0.5,
                         gs_min=0, gs_max=80, trace_side=TraceSide.NORMAL),
