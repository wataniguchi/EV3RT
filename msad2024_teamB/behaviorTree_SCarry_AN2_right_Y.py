...
class CheckMotorAngles(Behaviour):
    def init(self, name: str,right_power: int, left_power: int, total_ang_r: int, total_ang_l: int):
...
def build_behaviour_tree() -> BehaviourTree:
    ...
    step_02B.add_children(
        [
            ...
            MoveStraightLR(name="Turn 1", right_power=85, left_power=0, target_distance=157), #RIGHT
    ...
    step_03B_1.add_children(
        [
            MoveStraightLR(name="back", right_power=-50, left_power=-40,target_distance=500),
    ...
    step_03B_2.add_children(
        [
            ...
            MoveStraight(name="free run 3", power=50, target_distance=10000),
            IsColorDetected(name="black")
        ]
    )
    ...
    step_04B.add_children(
        [
            ...
            TraceLineCam(name="last run", power=50, pid_p=2.5, pid_i=0.0015, pid_d=0.1,
                         gs_min=0, gs_max=80, trace_side=TraceSide.CENTER),
