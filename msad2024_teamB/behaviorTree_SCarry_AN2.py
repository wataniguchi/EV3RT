...
def build_behaviour_tree() -> BehaviourTree:
    ...
    step_01B = Parallel(name="step 01B", policy=ParallelPolicy.SuccessOnSelected,children=[step_01B_1,step_01B_2](children=[step_01B_1,step_01B_2],synchronise = True))
