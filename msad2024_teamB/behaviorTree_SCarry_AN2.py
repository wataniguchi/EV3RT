...
def build_behaviour_tree() -> BehaviourTree:
    ...
    start = Parallel(name="start", policy=ParallelPolicy.SuccessOnAll())
    ...
    step_01B.add_children(
        [
            ...
            IsDistanceEarned(name="check distance blue", delta_dist = 200),
            Bottlecatch(name="linetrace pre", target_state = BState.PRELINE),
            Bottlecatch(name="linetrace pre", target_state = BState.LINE)
