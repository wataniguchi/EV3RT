...
#define TR_SLALOM_L \
    .composite<BrainTree::MemSequence>()\
        ...
        /*段差ストップ 3.0 sec*/\
            ...
            .leaf<TraceLine>(35, GS_TARGET, P_CONST, I_CONST, 0.04D, 0.0, TS_CENTER)\
        .end()\
        /*遠藤追加（疑似台形駆動）*/\
        .composite<BrainTree::ParallelSequence>(1,2) \
            .leaf<IsTimeEarned>(3000000) \
            .leaf<TraceLine>(25, GS_TARGET, P_CONST, I_CONST, 0.04D, 0.0, TS_CENTER)\
        .end()\
        .composite<BrainTree::ParallelSequence>(1,2)\
        ...
        .composite<BrainTree::ParallelSequence>(1,2)\
            ...
            .leaf<TraceLine>(40, GS_TARGET, P_CONST, I_CONST, 0.06D, 0.0, TS_CENTER)\
        .end()\
        /*スタブ用回転*/\
            .composite<BrainTree::ParallelSequence>(1,2) \
        ...
        .composite<BrainTree::ParallelSequence>(1,2)\
            ...
            .leaf<TraceLine>(40, 47, P_CONST, I_CONST, 0.04D, 0.0, TS_OPPOSITE)\
        .end()\
    .end()