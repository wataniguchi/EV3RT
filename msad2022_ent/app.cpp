...
//            .end()
           //タイヤのバランス戻す
            .composite<BrainTree::ParallelSequence>(1,2)
//                .leaf<IsTimeEarned>(3000000)
                .leaf<IsTimeEarned>(3700000)
                .leaf<RunAsInstructed>(69,69, 0.5)
            .end()

            .composite<BrainTree::ParallelSequence>(1,2)
//                .leaf<IsTimeEarned>(3000000)
                .leaf<IsTimeEarned>(1200000)
                .leaf<RunAsInstructed>(50,65, 0.5)
            .end()
